...
// 		times: 0,
// 		maxTimes: 100,
// 		interval: 5 * 60 * 1000, // 每五分钟更新一次
// 		ins: null,
// 	};
// 	interval.ins = setInterval(() => {
// 		console.log('interval fetch topics times: ', interval.times);
// 		if(interval.times > interval.maxTimes){
// 			clearInterval(interval.ins);
// 			redis.quit();
// 		}else {
// 			getGroupTopics();
// 		}
